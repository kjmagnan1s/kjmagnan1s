...
The last ~{weeks} weeks, pulled straight from local Claude Code logs and GitHub. I delegated most of this: I set the goal and the bar, the agents did the rest. A running total from here.
...
{ag['agents'] + ag['subagents']:,} agents ran, {ag['subagents']:,} of them inside {ag['workflows']} dynamic workflows. Designing that is the actual work.
