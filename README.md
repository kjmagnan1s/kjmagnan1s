...
I'm breaking my Claude Code skills out into their own repos. More landing here soon.

- **anti-slop**: one skill for AI-slop detection, rewrite, and ingestion. *(standalone repo coming soon)*
- *(more on the way)*

For now the working set lives in [claude-skills](https://github.com/kjmagnan1s/claude-skills).
