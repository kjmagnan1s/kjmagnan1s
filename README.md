...
The last ~4 weeks, pulled straight from local Claude Code logs and GitHub. I delegated most of this: I set the goal and the bar, the agents did the rest. A running total from here.

| Last 4 weeks &nbsp;·&nbsp; Aug 10 – Sep 9, 2026 | |
| :-- | --: |
| Tokens processed | **13.22B** |
| Commits | **139** |
| Pull requests (opened / merged) | **44 / 39** |
| Lines added | **+101K** |
| Repos active | **8** |
| Production apps shipped or in flight | **7+** |
| Agents spawned (direct / in workflows) | **242 / 128** |
| Dynamic workflows run | **19** |
| Claude Code skills written | **13** |

94.5% context cache reuse &nbsp;·&nbsp; 99% on frontier models (63% Opus, 36% Fable) &nbsp;·&nbsp; 79,215 agent turns.

370 agents ran, 128 of them inside 19 dynamic workflows. Designing that is the actual work.
