...
| Last 5 weeks &nbsp;·&nbsp; Aug 11 – Sep 14, 2026 | |
| :-- | --: |
| Tokens processed | **15.95B** |
| Commits | **206** |
| Pull requests (opened / merged) | **57 / 51** |
| Lines added | **+108K** |
| Repos active | **9** |
| Production apps shipped or in flight | **7+** |
| Agents spawned (direct / in workflows) | **225 / 182** |
| Dynamic workflows run | **27** |
| Claude Code skills written | **14** |

94.6% context cache reuse &nbsp;·&nbsp; 98% on frontier models (69% Opus, 29% Fable) &nbsp;·&nbsp; 93,892 agent turns.

407 agents ran, 182 of them inside 27 dynamic workflows. Designing that is the actual work.
