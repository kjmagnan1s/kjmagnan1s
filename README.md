...
The last ~7 weeks, pulled straight from local Claude Code logs and GitHub. I delegated most of this: I set the goal and the bar, the agents did the rest. A running total from here.

| Last 7 weeks &nbsp;·&nbsp; Jun 10 – Jul 29, 2026 | |
| :-- | --: |
| Tokens processed | **12.97B** |
| Commits | **188** |
| Pull requests (opened / merged) | **41 / 31** |
| Lines added | **+205K** |
| Repos active | **29** |
| Production apps shipped or in flight | **7+** |
| Agents spawned (direct / in workflows) | **293 / 627** |
| Dynamic workflows run | **44** |
| Claude Code skills written | **19** |

93.9% context cache reuse &nbsp;·&nbsp; 99% on frontier models (66% Opus, 32% Fable) &nbsp;·&nbsp; 71,896 agent turns.

920 agents ran, 627 of them inside 44 dynamic workflows. Designing that is the actual work.
